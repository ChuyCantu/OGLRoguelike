...
public:
    ...
    Buffer(uint32_t size, BufferUsage usage, const void* data = nullptr, BufferTarget target = BufferTarget::Null);
    Buffer(Buffer&& other);
    ...
    void Create(uint32_t size, BufferUsage usage, const void* data = nullptr, BufferTarget target = BufferTarget::Null);
